...
[期末專題 REPO連結](https://github.com/41371115h-dot/food)
---
...
<details>
<summary><strong>期末專題介紹</strong></summary>

<br>

### 功能:
- 1.隨機抽選: 先選擇地理位置、主食類型，例如想吃麵，然後口味類別勾選 例如想吃鹹的，價位也可以選擇，按下開始隨機推薦，就會有建議餐廳
- 2.分類篩選: 先選擇地理位置，接著直接點選你想要的分類，像是趕時間適合的餐廳有什麼，就會有數個建議餐廳
- 3.心情選擇: 選擇當下的心情，就會有數個建議餐廳
- 4.天氣選擇: 選擇地理位置，他會提供當地的天氣資訊，就會有數個建議餐廳
- 5.輸入需求: 輸入你的需求，就會有數個建議餐廳
- 6.餐廳料理推薦: 搜尋餐廳名稱，就會有該餐廳前10名菜色
### API
- gemini api: 生成結果
- openstreetmap api: 生成的結果顯示在地圖上，讓使用者能清楚知道這間餐廳大概在什麼位置
- weatherapi: 取得即時天氣資訊
